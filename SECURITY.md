...
target, and libFuzzer over the five parsers a target can hold to a return value: `BCH7`, `BMP7`,
`BCL1`, `OVL2`/`OVL1`, and the standalone `MPH2`/`MPH1` from inside, each run starting from the
