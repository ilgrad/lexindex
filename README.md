...
builds in 229 ms against `marisa-trie`'s 281–283, and the larger block trades reverse-lookup latency
for the bytes. `marisa-trie` appears three times for the same reason it has tuning parameters: its
