...
//!   the closed-vocabulary path, 3.9–8.9× faster than XCDAT's lookup — the fastest trie measured —
...
pub mod fuzzing {
    ...
    ///
    /// The other targets reach this format only through a `BMP8`/`BCH8` header, which means a
